...
const SKILLS = {
  awards: [
    { title: "SSAFY 14기 공통 프로젝트 우수상", date: "2026.02", org: "삼성청년SW·AI아카데미 (Samsung Youth Software Academy)", description: "CONY - 기프티콘 관리 및 판매 서비스 (6인 자유주제 팀 개발 프로젝트, 7주)" },
  ],
  certifications: [
    ...
    <section id="skills" className="py-24 px-4 bg-slate-50 dark:bg-slate-900/50">
      <div className="max-w-5xl mx-auto">
        <div className="mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700 view-trigger">
          <h2 className="text-4xl font-bold mb-3 text-foreground">수상 및 자격증</h2>
